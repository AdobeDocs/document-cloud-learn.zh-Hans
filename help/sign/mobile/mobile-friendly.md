---
title: 移动友好视图
description: 了解如何使用支持移动设备的视图在移动设备上填写表单
feature: Mobile, Sign
role: User
level: Beginner
jira: KT-18735
...
借助Mobile View，Acrobat Sign让任何人在移动设备上填写和签署表单都比以往任何时候都更容易，无论他们在哪里。 通过在移动设备上自动创建并提供简化的UI，移动视图可引导用户完成必要的表单字段，从而更容易通过以下方式高效准确地完成文档：

* 移动友好型字段：不再进行捏合和缩放，表单完美地适合您的屏幕
