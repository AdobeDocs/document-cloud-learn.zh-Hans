...
+ 数字身份证 {#digital-id}
   ...
   + Digidentity {#digidentity}
      + [注册和签名使用 [!DNL Digidentity]](digitalid/digidentity-sign.md)
   + D-Trust {#dtrust}
...
+ 集成 {#integrations}
   ...
   + Microsoft {#microsoft}
      ...
      + [跟踪 [!DNL SharePoint Online]](integrations/track-an-agreement-with-sharepoint-online.md)
      ...
      + [文档选项卡集成 [!DNL Microsoft Teams]](integrations/acrobat-sign-teams-documents-tab.md)
   ...
   + Salesforce {#salesforce}
      + [Document Builder版本 [!DNL Salesforce]](integrations/create-an-agreement-template.md)
   ...
   + Marketo {#marketo}
      + [使用Acrobat Sign发送通知 [!DNL Salesforce] 和Marketo](integrations/marketo-salesforce-sms.md)
      + [使用Acrobat Sign发送提醒 [!DNL Salesforce] 和Marketo视频教程](integrations/marketo-salesforce-reminder-video.md)
      + [使用Acrobat Sign发送提醒 [!DNL Salesforce] 和Marketo配置指南](integrations/marketo-salesforce-reminder.md)
      + [使用Acrobat Sign发送通知 [!DNL Microsoft Dynamics] 和Marketo](integrations/marketo-dynamics-sms.md)
      + [使用Acrobat Sign发送提醒 [!DNL Microsoft Dynamics 365] 和Marketo](integrations/marketo-dynamics-reminder.md)
+ 行业和部门 {#expand}
