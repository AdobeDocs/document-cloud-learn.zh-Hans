...
+ 开始使用 {#getting-started}
   ...
   + 发送 {#getting-started-sending}
      ...
      + [创建可重复使用的模板](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-template.html)
...
+ 高级任务 {#advanced-tasks}
   ...
   + 发送 {#advanced-tasks-sending}
      ...
      + [生成自定义工作流](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
