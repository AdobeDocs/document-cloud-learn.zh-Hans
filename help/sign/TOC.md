...
+ 开始使用 {#getting-started}
   ...
   + 发送 {#getting-started-sending}
      ...
      + [开始使用 Acrobat Sign](sign-beginner-tutorials/new-sender.md)
      + [发送文档至单个签名者](sign-beginner-tutorials/send-to-single-recipient.md)
      + [发送给多位签名者](sign-beginner-tutorials/send-to-multiple-recipients.md)
      ...
      + [创建可重用模板](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-template.html)
...
+ 高级任务 {#advanced-tasks}
   ...
   + 发送 {#advanced-tasks-sending}
      ...
      + [构建自定义工作流](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
   ...
   + 管理 {#advanced-tasks-managing}
      + [报表与事务用量](sign-advanced-users/creating-a-report.md)
...
+ 管理 {#admin-set-up}
   ...
   + 开始使用 {#getting-started-admin}
      + [新管理员快速入门指南](admin/get-started-admin.md)
      ...
      + [报表与事务用量](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
      ...
      + [配置和管理“修改协议”](admin/configure-modify-agreement.md)
...
+ 移动设备 {#mobile}
   ...
   + 移动教程 {#mobile-tutorials}
      ...
      + [支持移动设备的视图](mobile/mobile-friendly.md)
      + [创建适合移动设备的视图](mobile/create-mobile-friendly.md)
