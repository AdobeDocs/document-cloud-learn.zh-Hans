...
可通过[!DNL Adobe Sign Individual]Adobe Sign **工具或** Fill &amp; Sign **工具在Acrobat中访问** （[请求签名](https://www.adobe.com/acrobat/online/request-signature.html){target="_blank"}）。

在Acrobat DC![[!DNL Adobe Sign Individual]中访问](../assets/Deploy_SignEntitle1.png)
