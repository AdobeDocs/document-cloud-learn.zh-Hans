...
+ Acrobat Studio中的分析器 {#analyzer}
  ...
  + 使用案例 {#use-cases}
    + [合并与收购集成后合同审计](analyzer/use-case/m-and-a-post-audit.md)
    + [加快财会收入与审计评审](analyzer/use-case/accelerate-revenue.md)
    + [将数据隐私风险转变为全面可见性和监控](analyzer/use-case/data-privacy-risk.md)
