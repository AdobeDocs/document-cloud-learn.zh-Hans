...
+ 高级任务 {#advanced-tasks}
   ...
   + 创建和管理表单 {#forms}
      + [使用表单字段](advanced-tasks/workforms.md)
      + [高级表单字段](advanced-tasks/advancedforms.md)
      + [使用表单数据](advanced-tasks/formdata.md)
   + 保护 {#protect}
      + [删除敏感信息](advanced-tasks/redact.md)
   + 自动化和扩展工作流 {#automate}
      + [指导操作](advanced-tasks/action.md)
      + [自定义命令和工具](advanced-tasks/custom.md)
+ AI支持 {#ai-powered}
   + [概述](ai-powered/ai-overview.md)
   + [通过AI Assistant了解PDF分析](https://experienceleague.adobe.com/zh-hans/docs/document-cloud-learn/acrobat-learning/get-started/ai/ai-assistant)
   + [利用PDF Spaces提高团队效率](https://experienceleague.adobe.com/zh-hans/docs/document-cloud-learn/acrobat-learning/get-started/ai/pdf-spaces-legal)
   ...
   + [编辑PDF中的图形](https://experienceleague.adobe.com/zh-hans/docs/document-cloud-learn/acrobat-learning/get-started/edit/edit-graphics)
   + [设计此PDF](https://experienceleague.adobe.com/zh-hans/docs/document-cloud-learn/acrobat-learning/get-started/edit/stylize-this-pdf)
+ 用例 {#use-cases}
   + [概述](use-cases/use-cases-overview.md)
   + 业务线 {#lob}
      + [概述](use-cases/lob/finance/finance-overview.md)
      + 财务 {#finance}
         + [将财务报告转换为可供管理层使用的洞察](use-cases/lob/finance/finance-insights.md)
   + 政府版 {#gov}
      + [概述](use-cases/gov/gov-overview.md)
      + 随处使用Acrobat的5个提示 {#tips}
         + [有关随处使用Acrobat的5个提示](use-cases/gov/5-tips-for-working-anywhere-with-acrobat-dc-for-government.md)
