...
您还可以使用[!UICONTROL 工具]Action Wizard中的[使其可访问](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/action.html?lang=zh-Hans)操作，该操作将逐步完成一组创建可访问PDF的基本步骤。
