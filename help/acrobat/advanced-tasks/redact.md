...
了解如何使用“Redact Tool”（标记密文）工具永久删除PDF中的私人或敏感信息。 本教程还介绍了如何对文档进行动画化以移除文件中不可见的信息，如注释、元数据或隐藏的图层。 永久删除敏感内容和隐藏数据很重要，这样在发布PDF时信息就不会一起传递。 本教程使用[新的Acrobat体验](../getting-started/new-experience.md)。

**试用：**&#x200B;立即探索如何将[实操](https://w.adobedemo.com/s/7MUInu){target="_blank"}标记为密文。
...
>[!TIP]
>
>要加快密文过程，请在桌面版Acrobat Pro、Premium或Studio中查看[Action Wizard](../advanced-tasks/action.md)。
